     ...
     // receiving
      const receivedRef = doc (db,`users/${p2}`);
       ...
       const sendRef = doc (db,`users/${p1}`);
         await updateDoc(sendRef,  {
         marrysent: arrayUnion(obj2)
        })
 
       //  setShowAlert(true);
       alert("Marry connection sent!")
    ...
    mconnections.map((item,index) => (
      ...
      <div className="card " style={{width: '100%'}}>
        ...
        <div className="card-body">
          <h6 className="card-title">{Object.values(item)}</h6>
          ...
          <div className="d-flex flex-column ">
              ...
              <button className="primary"  onClick={() => getDetailonMarry(item)}>
              Marry
              </button>
