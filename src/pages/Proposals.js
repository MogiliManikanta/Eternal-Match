...
const Proposals = (props) => {
    ...
    const fetchMarryConnections = async () => {
      ...
      const docRef = doc(db, `users`, sender.uid)
    ...
    const fetchsetmembers = async () => {
      ...
      const fetchreceivedmembers = async () => {
        ...
        const handleAccept = async(sid) =>{
          ...
          var p1 = sender.uid;
          var p2 = Object.keys(sid)[0];
  
          // console.log(`sender : ${p1}`);
          // console.log(`receiver : ${p2}`);
  
          const docRef1 = doc (db,`users`,`${p1}`);
          const docSnap1 = await getDoc(docRef1);
          const senderName = docSnap1.data().username;
  
          const docRef3 = doc (db,`users`,`${p2}`);
          const docSnap3 = await getDoc(docRef3);
          const receiverName = docSnap3.data().username;
        ...
        obj2[key2] = receiverName;
                  ...
                  const receivedRef = doc (db,`users`,`${p2}`);
                  await  updateDoc(receivedRef,  {
                    marryconnections: arrayUnion(obj1)
                   })
                
            
                   //sending
                  const sendRef = doc (db,`users`,`${p1}`);
                    await updateDoc(sendRef,  {
                    marryconnections: arrayUnion(obj2)
                   })


                    var newObject = {};

                    newObject[key1] = senderName;
                    newObject[key2] = receiverName;
                ...
                temp = temp.filter(function(value, index, arr){ 
                  return Object.keys(value)[0] !== p2;
              })
                var temp2 = data2.marrysent
                temp2 = temp2.filter(function(value, index, arr){ 
                  return Object.keys(value)[0] !== p1;
              })
        
              // receiving
                const receivedRef2 = doc (db,`users`,`${p2}`);
               ...
               //sending
                const sendRef2 = doc (db,`users`,`${p1}`);
                  await updateDoc(sendRef2,  {
                  marryreceived: temp
                 })
  
  
           alert("Added to your marry connection!")
        ...
        return (
          ...
          <label htmlFor="tab3"> {t('Marry Connections')} </label>
        ...
        
        {
          ...
          <h3 className="rcb" style={{
              ...
              }}>{t(`You haven't sent any proposal!`)}</h3>
        ...
        {
          marrysentReqMem.map((item,index) => (
            <div className="col-sm-4"  key={Object.keys(item)[0]}>
...
<div className="buttons d-flex flex-row" style={{marginLeft:"-18px"}}>
  ...
  <h3 className="rcb" style={{
              marginLeft:"5%",
            justifyContent:"center"
      }}>{t(`You haven't received any proposal!`)}</h3>
    ...
    <img style={{
      ...
      justifyContent:"center"
        ...
        {
          marryreceivedReqMem.map((USER,index) => (
            <div className="col-sm-4" key={Object.keys(USER)[0]}>
            <div className="card " style={{width: '100%'}}>
              <img src="data:image/png;base64,"  className="card-img-top" alt="..." />
              <div className="card-body">
                <h5 className="card-title"></h5>
...
<div className="buttons d-flex flex-row" style={{marginLeft:"0px"}}>
  ...
  <h3 className="rcb" style={{
              marginLeft:"5%",
            justifyContent:"center"
      }}>{t(`You don't have any marry connection yet!`)}</h3>
    ...
    {
      marryConnections.map((USER,index) => (
        <div className="col-sm-4" key={Object.keys(USER)[0]}>
        <div className="card " style={{width: '100%'}}>
          <img src="data:image/png;base64,"  className="card-img-top" alt="..." />
          <div className="card-body">
