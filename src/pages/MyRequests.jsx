...
<div className="buttons d-flex flex-row">
  <button className="primary" onClick={() => handleAccept(Object.keys(USER)[0])} >
  ✔️
  </button>
  <button className="primary ghost"  onClick={() => handleReject(Object.keys(USER)[0])} >
  ❌
  </button>
</div>
